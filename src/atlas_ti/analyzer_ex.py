...
if __name__ == '__main__':
    ...
    quotations, primary_docs, codes = quotation_count.load_data(quotation_path)

    print(len(quotations))

    code_error_check(quotations)

    disciplines = ['eco', 'law', 'pol', 'soc', 'psy']

    quotation_count, code_count, skipped = table_1(quotations, disciplines, ['Wrong Data', 'I-NA'])
    '''
    # 표 1
